...
- **LLM abstraction** (`lib/llm.ts`) — Vercel AI SDK supporting Anthropic, OpenAI, DeepSeek. Provider-agnostic via `LLM_PROVIDER` + `LLM_API_KEY` env vars. Returns 503 when not configured.
