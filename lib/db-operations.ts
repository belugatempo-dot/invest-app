  ...
  for (const stock of scoredStocks) {
    ...
    await db
      ...
      .values({
        ...
        sentimentMentions: stock.sentimentMentions ?? null,
        sentimentMentionsPrev: stock.sentimentMentionsPrev ?? null,
        sentimentRank: stock.sentimentRank ?? null,
        sentimentSource: stock.sentimentSource ?? null,
